const reviews = [
  {
    ...
    image: "https://miro.medium.com/v2/resize:fit:1280/0*ngAthWxOvKZHvsw9",
    text: "I'm a Frontend Web Developer, I have mastered in HTML, CSS, JavaScript, Tailwind, React, and Node Js I'm Polishing my skills in Backend Technologies to provide the Industry well proficient, easy to understand and maintenable code and also to become a efficient Open Source Contributor." 
  },
  {
    id: 2,
    name: "Abir Pal",
